...
var Translate = function (_Component) {
  ...
  _createClass(Translate, [{
    ...
    value: function _getText(text) {
      let lan = window.localStorage.getItem("languageLib");
      if (lan != this.defaultLanguage && text) {
        if (this.translations[text] && this.translations[text][lan]) {
          return this.translations[text][lan];
        } else {
          return text;
        }
      } else {
    ...
    value: function _changeLanguage(event) {
      window.localStorage.setItem("languageLib",event.detail);
